...
<?php 
include('Public/includes/toph.php');
?>
					...
					<div class="row">
						<div class="col-md-12">
							<div class="slider-content">
								...
								<h1 class="section-title">Fastest Growing<br> City Uvira</h1>
				...
				<div class="col-lg-6">
					<div class="about-image">
						<div class="about-image-inner img-one">
							...
							<div class="sign-text">Pst. Kiza Muhato</div><!-- sign-text -->
							<div class="about-image-caption">
								<div class="about-image-caption-inner">
									<span class="about-caption-number">4</span>
					...
					<div class="about-inner">
						...
						<div class="about-author-box">
							...
							<div class="about-author-box-meta">
								<h5>Pasteur Kiza MUHATO</h5>
								<span>Maire de la ville</span>
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-6">
					<div class="mayor-box">
						<div class="section-title-box">
							<div class="section-tagline">MAIRE D'UVIRA</div><!-- section-tagline -->
