                                ...
                                <form method="POST" id="login_form" class="form-validate is-alter" autocomplete="off">
                                    <div class="form-group">
                                        ...
                                        <div class="form-control-wrap">
                                            <input autocomplete="off" type="text" id="email" name="email" class="form-control form-control-lg" required placeholder="Enter your username">
                                        </div>
                                    </div><!-- .form-group -->
                                    <div class="form-group">
                                        <div class="form-label-group">
                                    ...
                                    <div class="form-group">
                                        <button class="btn btn-lg btn-info btn-block" name="login">Sign in</button>
                                    </div>
                                 <div>
                                    <?php 
                                        // code...
