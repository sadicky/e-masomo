<?php 
$title = 'Repairable Device Information';
...
<body class="nk-body bg-lighter npc-general has-sidebar ">
                            ...
                            <div class="nk-content-body">
                                <div class="nk-block-head nk-block-head-sm">
                                    <div class="nk-block-between">  
                                        ...
                                        <div class="nk-block-head-content">
                                                        <a href="#" class="btn btn-primary"  data-bs-toggle="modal" data-bs-target="#add-device"><em class="icon ni ni-plus"></em><span>New Device</span></a>
    ...
    <?php 
include('Public/modals/adddevice.php');
include 'Public/modals/editdevice.php';
include('Public/includes/footer.php');
?>

<script type="text/javascript" src="Public/ajax/device.js"></script>