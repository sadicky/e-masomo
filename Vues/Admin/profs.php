...
<body class="nk-body bg-lighter npc-general has-sidebar ">
                            ...
                            <div class="nk-content-body">
                                <div class="nk-block-head nk-block-head-sm">
                                    <div class="nk-block-between">  
                                        ...
                                        <div class="nk-block-head-content">
                                                        <a href="#" class="btn btn-primary"  data-bs-toggle="modal" data-bs-target="#add-prof"><em class="icon ni ni-plus"></em><span>Nouveau Professeur</span></a>
                                        ...
                                        <div class="card card-bordered card-preview">
                                            <div class="card-inner">
                                                <table class="datatable-init-export nowrap table" data-export-title="Export">
                                                    ...
                                                    <tbody>                                                        
                                                        <?php $cnt = 1;
                                                        foreach ($getProfs as $user) : ?> 
                                                            <tr>
                                                                <td><?= $cnt ?></td>
									                            <td><u><a href='index.php?p=profdet&id=<?=$user->mat?>' > <?=$user->mat?></u></a></td>
                                                                <td><a href="index.php?p=viewprof&id=<?=$user->mat?>"><?=$user->noms?></a></td>
                                                                <td><?=$user->email?></td>
                                                                <td><?=$user->tel?></td>
                                                                <td><?php 
                                                            ...
                                                            <td>
                                                                    <button type="button"  data-bs-toggle="modal" id="<?= $user->mat ?>"  class="btn btn-xs btn-danger view_prof"
                                                                    title='Lui affecter un cours'><em class="icon ni ni-shuffle"></em>Attribuer Cours</button>
                                                            </td>
                                                            </tr>                                                        
                                                        <?php $cnt++;
                                                        endforeach ?>
    ...
    <?php 
include('Public/modals/addprof.php');
